...
import { UseTranslate, type Translation } from "../utils/translator";
...
export default function ProjectTile({
  ...
  return (
    <motion.div layout layoutId={generateId()} key={getString(proj.title)} >
      <motion.div
        initial={{
          opacity: 0,
        }}
      ...
      >
        ...
        <h3 className="text-2xl font-bold pt-4 px-6 uppercase">{t(proj.title)}</h3>
        <p className="py-2 px-4">{getString(proj.shortDescription)}</p>
